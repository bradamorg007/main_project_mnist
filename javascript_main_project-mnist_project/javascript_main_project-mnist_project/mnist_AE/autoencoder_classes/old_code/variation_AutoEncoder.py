...
class VariationAutoEncoder(AutoEncoder):
    ...
    def define_model(self):
        ...
        d = layers.Dense(units=32, activation='relu')(decoder_inputs)
...
if __name__ == '__main__':
    VAE = VariationAutoEncoder(img_shape=(28, 28, 1), latent_space_dims=15, batch_size=64)
    VAE.data_prep(keep_labels=[1])
    VAE.define_model()
    VAE.train(epochs=20)
    VAE.inspect_model(dim_reduction_model='tsne')
    VAE.save(name='vae_test', save_type='weights_and_reconstruction_error')
